...
# 搭建方式2：Cloudflare-workers/pages代理脚本【目前版本：2026.9】
### 1、本项目仅支持本地化部署
...
1、安卓Android：[v2rayNG](https://github.com/2dust/v2rayNG/tags)、[Nekobox](https://github.com/starifly/NekoBoxForAndroid/releases)、[Karing](https://github.com/KaringX/karing/tags)
